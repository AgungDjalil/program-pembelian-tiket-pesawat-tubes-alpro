...
def buat_data():
    ...
    jurusan = dari + '->' + ke
    data_utuh = operasi.data_penumpang(
        total_penumpang, thn_tgl_bln, waktu, maskapai, jurusan)

    loading()

    # Tampilan Akhir
    flight_detail(maskapai, dari, ke, tanggal, bulan, tahun, nama_pemesan, nomor_pemesan,
                  email_pemesan, data_utuh, total_harga, original, insurance, waktu)
